...
export default function StackNavigation(props) {
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen name="home" component={Home} options={{title:"MovieApp",headerLeft:()=> buttonLeft("home"), headerRight:() => buttonRight() }} />
            ...
            <Stack.Screen name="popular" component={Popular} options={{title:"Populares",headerLeft:()=> buttonLeft("popular"), headerRight:() => buttonRight()}} />
